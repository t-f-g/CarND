      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            // Later we will interpolate these waypoints with a spline and fill it in with more points that contrl speed

            vector<double> ptsx;
            vector<double> ptsy;

            // reference x,y, yaw states
            // either we will reference the stasrting point as where the car is o rat the previous paths end point
            double ref_x = car_x;
            double ref_y = car_y;
            double ref_yaw = deg2rad(car_yaw);

            // if previous size is almost empyt, use the car as a stasrting referenceo
            if(prev_size < 2)
            {
            ...
            // use the previous path's and point as starting reference
              ...
              //Use two points tha tmake the path tangent to the previous path's end point
            ...
            // Calculate how to break up spline points so that we travel at our esired refence velocity
            ...
            // Fill up the rest of our path planner after filling it with prevoius points, here we willi always output
